...
# --- PPO Agent Class (Must match the training architecture) ---
...
class Vehicle:
    def __init__(self, direction):
        ...
        # Offset from the *center* of the road (e.g., 25 or 75)
    ...
    def update(self, lights, vehicles_ahead):
        ...
        for v in vehicles_ahead:
            # Only check cars in same direction and same lane
    ...
    def draw(self, surface, font):
        ...
        # Make EV's unmissable
        if self.is_emergency:
            surf.fill(EV_WHITE) # Bright white base
...
class TrafficSimulation:
    ...
    def get_state(self):
        # Model state (unchanged, as model expects 30 features)
    ...
    def draw_all_lights(self):
        ...
        self.screen.blit(label_surf, (x - label_surf.get_width() // 2, y + 35)) # Below
    ...
    def run(self):
        ...
        while running:
            self.screen.fill(GRAY) # Background
            self.draw_roads()
            ...
            # Sort by y to draw correctly (for 2.5D overlap)
